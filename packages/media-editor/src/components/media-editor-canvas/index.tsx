...
export default function MediaEditorCanvas( {
	...
	return (
		<div className="media-editor-canvas">
			 ...
			 *
			 * The cropper is never focused on mount: the crop area is one of
			 * several flows in the modal, so initial focus belongs on the
			 * dialog container, which the `Modal` handles.
			 */ }
			<div
